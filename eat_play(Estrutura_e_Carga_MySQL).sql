...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Nov-2019 às 05:26
...
(1, 'Lanches', 'lanches.jpg', 'lanches.jpg', '2019-11-12 20:06:54'),
(2, 'Pratos prontos', 'pratos.jpg', 'pratos.jpg', '2019-11-12 20:07:10'),
...
(1, 'Pastel de Frango', 'Lanches', 3, '2019-07-03 00:41:30'),
...
INSERT INTO `users` (`id`, `name`, `login`, `password`, `date`, `status`) VALUES
(1, 'Administrador', 'root', '123', '2019-11-04', 1),
(2, 'user', '123', '123', '2019-11-04', 0),
(3, 'admin', 'admin', '123', '2019-11-12', 1);
...
--
-- Índices para tabela `take_orders`
--
...
--
-- AUTO_INCREMENT de tabela `take_orders`
--
ALTER TABLE `take_orders`
