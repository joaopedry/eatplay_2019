...
-->                
      ...
      <div class="container">
		...
		?>
                <div class="cardapios" style="width:200px;position:relative;margin-left:20px;float: left;text-align:center;">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $selecmenu['id']; ?>">Visualizar</button>
    ...
    <div class="site-section" id="teachers-section">
      <div class="container">
          ...
          <div class="TituloPedido"  data-aos="fade-up" data-aos-delay=""  >
          ...
          <div class="pedido" >
            <form action="admin/pedidos.php" method="post">
            	...
            	<input type="text" class="form-control" name="nome" onkeyup="validar(this,'text');" autocomplete="off" required="required">
                <label>Telefone:</label>
              <input type="text" class="form-control" name="telefone" id="telefone" maxlength="15" pattern=".{13,}" required title="Informar o telefone corretamente!" autocomplete="off" required="required" min=>
          </div>
			<?php
				if(isset($_GET['mesa']))
				{
					$numQR = $_GET['mesa'];
            ?>
				<input type="hidden" class="form-control" name="mesa" readonly value="<?php echo $numQR ?>">
                 <?php 
				 unset($_GET['mesa']);
				 }else{
				 ?><input type="hidden" class="form-control" name="mesa" readonly value="Externo">
				 <?php }?>
                ...
                <select style="width:80%" class="form-control" id="comida" name="comida<?php echo $count?>">
                ...
                <input style="width:19%; float:right; margin-top:-48px" placeholder="QTD" class="form-control" autocomplete="off" onkeyup="validarQTD(this,'text');" name="quantidade<?php echo $count?>" type="text" min="0" value="" maxlength="2" >
                <?php 
					}?>
                <br>
                ...
                <textarea class="form-control" name="texto" maxlength="240"></textarea>
                <br>
                <input type="submit" class="btn btn-primary" style="width:100%" name="pedido" title="Realizar pedido" value="Realizar pedido">
            </form>
