...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <header>
    	...
    	<section class="conteudo">
            <div class="titulo">
                <h1>Pedidos</h1>
                <a href="adicionacadastrapedidos.php"><img title="Adicionar" src="img/btn_adicionar.png"></a>
            </div>
                <table class="ExibeForm">
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" href="editar.php?acao=atualizarComida&id=<?php echo $selecComida['id']; ?>">Editar</a>
                                <a onClick="return ConfirmarAlteracao()" class="btn btn-secondary" href="query.php?deletarComida&id=<?php echo $selecComida['id']; ?>">Excluir</a>
                            </td>
                        </tr>
                        <?php 
                        }?>
