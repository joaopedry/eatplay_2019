...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <header>
    	...
    	<section class="conteudo">
            <div class="titulo">
                <h1>Imagens</h1>
                <a href="adicionacadastraimagem.php"><img title="Adicionar" src="img/btn_adicionar.png"></a>
            </div>
            <div>
                <table class="ExibeForm">
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a onClick="return ConfirmarAlteracao()" class="btn btn-secondary" href="query.php?deletarIMG=<?php echo $arqName;?>">Excluir</a>
                            </td>
                        </tr>
                        <?php 
                        }
