                                    ...
                                    <td>
                                        <form action="pedidos.php" method="post">
                                            ...
                                            ?>
                                                ...
                                                <button onClick="return ConfirmarFinaliza()" class="btn btn-primary" type="submit" name="finalizar">Finalizar</button>
                                                <br />
                                                <input onClick="return ConfirmarCancela()" class="btn btn-secondary" type="submit" name="cancelar" value="Cancelar"></input>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $selecTipo['id_order']; ?>">Visualizar</button>
